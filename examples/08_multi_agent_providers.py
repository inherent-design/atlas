...
def create_controller_with_workers(
    ...
    retrieval_worker = RetrievalWorker(
        providers=worker_providers, provider_strategy="failover", task_aware=worker_task_aware
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--task-aware", action="store_true", help="Enable task-aware provider selection"
    )
