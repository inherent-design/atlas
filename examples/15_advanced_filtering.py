...
from common import setup_example, print_example_footer, ensure_example_data, handle_example_error
...
def main():
    ...
    try:
        ...
        try:
            ...
            print("This might happen if your ChromaDB version doesn't support where_document filtering")
        ...
        try:
            ...
            print("This might happen if your ChromaDB version doesn't fully support combined filters")
            print("Try using version 1.0.8 or later of ChromaDB")
