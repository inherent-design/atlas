...
def test_with_resolution_from_capability():
    ...
    print(f"Direct capability check: premium mock model = {get_model_by_capability('mock', 'premium')}")
...
def main():
    ...
    args = setup_example(
        "Atlas Agent ProviderOptions Verification",
