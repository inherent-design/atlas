...
/**
 * Generate a deterministic 16-dimensional embedding from a seed.
 *
...
export function generateEmbedding(seed: string): number[] {
  ...
  // Generate 16 values using hash as seed
  for (let i = 0; i < 16; i++) {
...
export const EMBEDDINGS = {
  ...
  zero: new Array(16).fill(0),
  /** Unit vector (all components equal) */
  unit: new Array(16).fill(1 / Math.sqrt(16)),
