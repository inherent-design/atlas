...
def test_controller_agent(args):
    ...
    controller = ControllerAgent(system_prompt_file=args.system_prompt, worker_count=3)
...
def test_coordinator(args):
    ...
    coordinator = AgentCoordinator(
        system_prompt_file=args.system_prompt, worker_count=3
    )
...
def test_workflows(args):
    ...
    rag_result = run_rag_workflow(
        query=query, system_prompt_file=args.system_prompt, config=config
    )
