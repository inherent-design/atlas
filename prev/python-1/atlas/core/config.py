...
from atlas.core.errors import ConfigurationError, ErrorSeverity, ValidationError
...
class AtlasConfig:
    ...
    def __init__(
        ...
        worker_count: int = 3,
        provider_options: ProviderOptionsType | None = None,
    ):
    ...
    def get_provider_options(self):
        ...
        return ProviderOptions(model_name=self.model_name, max_tokens=self.max_tokens)
