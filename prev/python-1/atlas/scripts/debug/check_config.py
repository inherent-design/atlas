...
def parse_args():
    ...
    parser.add_argument("--env-file", type=str, help="Path to custom .env file to load")
    parser.add_argument(
        "--validate-api-keys",
        action="store_true",
    ...
    for provider_name in provider_names:
        ...
        if provider_name == "ollama":
            ...
            try:
                ...
                print(f"  Server: NOT RUNNING ({e!s})")
        else:
        ...
        if provider_name in available_providers and (has_key or provider_name == "ollama"):
            ...
            try:
                ...
                print(f"    Error retrieving models: {e!s}")
        ...
        if validate_api_keys and (has_key or provider_name == "ollama"):
            ...
            try:
                ...
                print(f"    Error validating API key: {e!s}")
...
def main():
    ...
    providers_to_check = (
        ["anthropic", "openai", "ollama"] if args.provider == "all" else [args.provider]
    )
