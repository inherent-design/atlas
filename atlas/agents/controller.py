...
class ControllerAgent(AtlasAgent):
    ...
    def __init__(
        ...
        worker_providers: Optional[Sequence[ModelProvider]] = None,
    ...
    def process_message(
        ...
        try:
            ...
            import logging
            logging.error(f"Error in controller processing: {str(e)}", exc_info=True)
    ...
    def process_message_streaming(
        ...
        try:
            ...
            import logging
            logging.error(f"Error in controller streaming: {str(e)}", exc_info=True)
