...
def create_mock_message_response(content: str, input_tokens: int = 100, output_tokens: int = 50) -> MagicMock:
...
def assert_cost_tracking_called(mock_response, input_tokens: int = 100, output_tokens: int = 50) -> None:
