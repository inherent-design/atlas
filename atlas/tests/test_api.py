...
def run_tests(test_name: str, system_prompt: Optional[str] = None, query: Optional[str] = None):
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        ...
        print("Alternatively, you can use test_mock.py which doesn't require an API key.")
        sys.exit(1)
