...
class ModelMessage:
    ...
    @classmethod
    def user(cls, content: Union[str, MessageContent, List[MessageContent]], name: Optional[str] = None) -> "ModelMessage":
    ...
    @classmethod
    def assistant(cls, content: Union[str, MessageContent, List[MessageContent]], name: Optional[str] = None) -> "ModelMessage":
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.content, str):
            ...
            if len(self.content) == 1:
                ...
                result["content"] = [c.text for c in self.content]
...
class ModelRequest:
    ...
    def __post_init__(self):
        ...
        if self.system_prompt and not any(msg.role == ModelRole.SYSTEM for msg in self.messages):
    ...
    def to_provider_request(self, provider_name: str) -> Dict[str, Any]:
        ...
        if provider_name.lower() == "anthropic":
            ...
            system_messages = [msg for msg in self.messages if msg.role == ModelRole.SYSTEM]
            if system_messages:
                ...
                request["messages"] = [msg.to_dict() for msg in self.messages 
