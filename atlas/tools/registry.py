...
from atlas.tools.base import Tool, AgentToolkit
...
class ToolRegistry:
    ...
    def create_tool(self, name: str, **kwargs) -> Optional[Tool]:
    ...
    def create_toolkit(self, tool_names: List[str], agent_id: Optional[str] = None) -> AgentToolkit:
...
def get_tool_class(name: str) -> Optional[Type[Tool]]:
...
def create_tool(name: str, **kwargs) -> Optional[Tool]:
...
def create_toolkit(tool_names: List[str], agent_id: Optional[str] = None) -> AgentToolkit:
...
def create_toolkit_with_all_tools(agent_id: Optional[str] = None) -> AgentToolkit:
