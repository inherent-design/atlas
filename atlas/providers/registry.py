...
from typing import Dict, List, Set, Optional, Union, Type, Any, Callable
...
class ProviderRegistry:
    ...
    def __init__(self):
        ...
        if self.__class__._instance is not None:
            logger.warning("ProviderRegistry should be accessed via get_instance(), not directly instantiated")
    ...
    def register_model_capability(
        ...
        model_name: str,
        capability: str,
        strength: Union[CapabilityStrength, int] = CapabilityStrength.MODERATE
    ) -> 'ProviderRegistry':
        ...
        with self._lock:
            ...
            if model_name not in self._model_providers:
                logger.warning(f"Model '{model_name}' not registered with any provider. Capability will still be recorded.")
    ...
    def get_models_by_capability(
        self, 
        capability: str,
        min_strength: Union[CapabilityStrength, int] = CapabilityStrength.BASIC,
    ...
    def find_provider_by_model(self, model_name: str) -> Optional[Type[ModelProvider]]:
    ...
    def find_models_with_capabilities(
        self,
        capabilities: Dict[str, Union[CapabilityStrength, int]],
        provider_name: Optional[str] = None
    ) -> List[str]:
    ...
    def create_provider(
        ...
        capabilities: Optional[Dict[str, Union[CapabilityStrength, int]]] = None,
        **kwargs
        ...
        with self._lock:
            ...
            if not provider_name:
                raise ValueError("Could not determine provider - please specify provider_name, model_name, or capabilities")
