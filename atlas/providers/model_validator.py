...
def validate_anthropic_model(model_name: str) -> Tuple[bool, Optional[str]]:
    ...
    if not model_name.startswith("claude-"):
        return False, f"Model '{model_name}' is not a valid Claude model. Model names should start with 'claude-'."
    
    # Return generic error for other cases
    return False, f"Model '{model_name}' is not a recognized Anthropic model."


def validate_openai_model(model_name: str) -> Tuple[bool, Optional[str]]:
...
def validate_ollama_model(model_name: str) -> Tuple[bool, Optional[str]]:
