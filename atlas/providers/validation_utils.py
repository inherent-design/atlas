...
def validate_model_compatibility(
    ...
    required_capabilities: Optional[Dict[str, int]] = None
) -> Callable[[F], F]:
            ...
            if model_name:
                ...
                if disallowed_models and model_name in disallowed_models:
                    ...
                    raise ProviderValidationError(
                        ...
                        provider=provider_name,
                        details={"disallowed_models": disallowed_models, "requested_model": model_name}
                    )
...
def validate_provider_features(
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(self: Any, *args: Any, **kwargs: Any) -> Any:
            ...
            elif "options" in kwargs and kwargs["options"]:
