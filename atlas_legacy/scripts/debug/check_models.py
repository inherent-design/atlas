...
def check_anthropic_models():
    ...
    try:
        ...
        try:
            if hasattr(client, "models") and callable(client.models.list):
                ...
                print("Test successful with model: claude-3-haiku-20240307")
            ...
            print(f"Error checking Anthropic models: {e!s}")
            return False
...
def check_openai_models():
    ...
    try:
        ...
        try:
            ...
            print(f"Error checking OpenAI models: {e!s}")
            return False
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    print(f"\nError listing Ollama models: {e!s}")
