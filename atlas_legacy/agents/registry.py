...
def register_agent(agent_name: str, class_path: str) -> None:
    ...
    _AGENT_CLASSES.pop(agent_name, None)
    _AGENT_CONSTRUCTORS.pop(agent_name, None)
...
class AgentRegistry(TracedClass):
    ...
    def register(
        self,
        agent_name: str,
        agent_class: type[AtlasAgent] | None = None,
        class_path: str | None = None,
        constructor: Callable[..., AtlasAgent] | None = None,
    ) -> None:
    ...
    def get(self, agent_name: str | None = None) -> AtlasAgent:
