...
TASK_CAPABILITY_REQUIREMENTS: dict[str, dict[str, CapabilityStrength]] = {
    ...
    TASK_TRANSLATION: {CAPABILITY_MULTILINGUAL: CapabilityStrength.STRONG},
...
def detect_task_type_from_prompt(prompt: str) -> str | None:
    ...
    for part in capability_str.split(","):
        ...
        if ":" in part:
            ...
            try:
                ...
                strength_level = cast(
                    CapabilityStrength, getattr(CapabilityStrength, strength.upper())
                )
