...
from atlas.providers.model_validator import ensure_valid_model, validate_model_for_provider
        ...
        if provider_type:
            ...
            if model_name:
                ...
                if not is_valid:
                    raise ProviderValidationError(
                        error_message
                        or f"Invalid model '{model_name}' for provider '{provider_type}'",
            ...
            if validated_config.get("options"):
                ...
                if provider_validator:
                    ...
                    try:
                        if provider_type == "anthropic":
                            validate_anthropic_options(lambda s, o: o)(
                                None, options=validated_config["options"]
                            )
                        elif provider_type == "openai":
                            validate_openai_options(lambda s, o: o)(
                                None, options=validated_config["options"]
                            )
                        elif provider_type == "ollama":
                            validate_ollama_options(lambda s, o: o)(
                                None, options=validated_config["options"]
                            )
                    except ProviderValidationError as e:
