...
from atlas.providers.streaming.control import StreamControlBase, StreamState
...
class EnhancedStreamHandler(StreamHandler, StreamControlBase):
    ...
    def __init__(
        ...
        buffer_config = {"max_buffer_size": max_buffer_size, "tokens_per_second": rate_limit}
    ...
    def start_processing(self) -> None:
        ...
        thread = threading.Thread(
            target=self._processing_loop, daemon=True, name=f"stream-processor-{id(self)}"
        )
