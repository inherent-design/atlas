...
class EnumField(fields.Field):
    ...
    def _serialize(self, value: Enum | None, attr: str | None, obj: Any, **kwargs) -> str | None:
        ...
        if isinstance(value, self.enum_class):
            return str(value.value) if self.by_value else value.name
        return str(value)
    ...
    def _deserialize(
        ...
        try:
            ...
            valid_values = [f"{enum.name} ({enum.value})" for enum in self.enum_class]
