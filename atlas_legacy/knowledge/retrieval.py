...
class RetrievalFilter:
    ...
    def add_range_filter(
        self, key: str, min_value: Any, max_value: Any, inclusive: bool = True
    ) -> "RetrievalFilter":
        """Add a range filter.
    ...
    @staticmethod
    def combine_filters(
        filters: list["RetrievalFilter"], operator: str = "$and"
    ) -> "RetrievalFilter":
...
class KnowledgeBase:
    ...
    def retrieve(
        ...
        try:
            ...
            print(f"Error retrieving from knowledge base: {e!s}")
            print(f"Query was: {query[:50]}...")
            print(f"Stack trace: {sys.exc_info()[2]}")
            logger.error(f"Error retrieving from knowledge base: {e!s}")
            return []
    ...
    def get_versions(self) -> list[str]:
        ...
        try:
            ...
            print(f"Error getting versions: {e!s}")
            logger.error(f"Error getting versions: {e!s}")
            return []
    ...
    def search_by_metadata(
        ...
        try:
            ...
            print(f"Error searching metadata: {e!s}")
            logger.error(f"Error searching metadata: {e!s}")
            return []
    ...
    def get_metadata_fields(self) -> list[str]:
        ...
        try:
            ...
            print(f"Error getting metadata fields: {e!s}")
            logger.error(f"Error getting metadata fields: {e!s}")
            return []
